...
import { cubeOptions, OrbitControls } from 'three/examples/jsm/controls/OrbitControls.js';
...
export const repoCube = new THREE.Mesh(repoCubeGeometry, repoCubeMaterial);
scene.add(repoCube);
scene.add(cube);
